...
3. **Register** the template. Open `templates/registry.js` and follow the same pattern used for `infosec-iso27001`:
...
The tool ships Chart.js and jsPDF locally so it works offline and under `file://`. Versions are pinned in `assets/js/vendor/README.md`.
...
1. Update the version table in `assets/js/vendor/README.md`.
